...
public class MyAdapter02 extends RecyclerView.Adapter<MyAdapter02.ViewHolder> {
    ...
    public MyAdapter02(List<MyDataItem> dataItemList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.product_card02, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.buttonPublish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    intent.putExtra("productId", dataItem.getId());
                    // 启动 Activity
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            buttonPublish = view.findViewById(R.id.buttonPublish); //详情信息按钮
        }
    }
}
